---
name: reviewer
description: Proactively use for independent read-only adversarial review of a proposed or implemented change when a separate falsifying pass improves confidence. Covers correctness, invariants, regressions, concurrency, data consistency, public contracts and missing tests.
model: claude-opus-5
effort: medium
